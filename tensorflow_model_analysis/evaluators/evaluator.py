...
def verify_evaluator(evaluator: Evaluator,
  ...
  """
  if (evaluator.run_after
      and evaluator.run_after != extractor.LAST_EXTRACTOR_STAGE_NAME
      and all(evaluator.run_after != x.stage_name for x in extractors)):
    raise ValueError(
        f'Extractor matching run_after={evaluator.run_after} for Evaluator {evaluator.stage_name} not found'
    )
